...
typedef enum PED_OBJECTIVE {
    ...
    PED_OBJECTIVE_UNKNOWN_4 = 4,
    PED_OBJECTIVE_UNKNOWN_5 = 5,
    PED_OBJECTIVE_UNKNOWN_6 = 6,
    PED_OBJECTIVE_UNKNOWN_7 = 7,
    PED_OBJECTIVE_UNKNOWN_8 = 8,
    PED_OBJECTIVE_UNKNOWN_9 = 9,
    PED_OBJECTIVE_UNKNOWN_10 = 10,
    PED_OBJECTIVE_UNKNOWN_11 = 11,
    PED_OBJECTIVE_GO_TO_AREA_ON_FOOT = 12,
    PED_OBJECTIVE_UNKNOWN_13 = 13,
    PED_OBJECTIVE_GO_TO_AREA_IN_CAR = 14,
    PED_OBJECTIVE_UNKNOWN_15 = 15,
    PED_OBJECTIVE_GO_TO_CHAR_ON_FOOT = 16,
    PED_OBJECTIVE_UNKNOWN_17 = 17,
    PED_OBJECTIVE_UNKNOWN_18 = 18,
    PED_OBJECTIVE_KILL_CHAR_ANY_MEANS = 19,
    PED_OBJECTIVE_KILL_CHAR_ON_FOOT = 20,
    PED_OBJECTIVE_UNKNOWN_21 = 21,
    PED_OBJECTIVE_UNKNOWN_22 = 22,
    PED_OBJECTIVE_BEAT_OR_ROB_CHAR = 23,
    PED_OBJECTIVE_GUARD_SPOT = 24,
    PED_OBJECTIVE_GUARD_AREA = 25,
    PED_OBJECTIVE_WAIT_ON_FOOT = 26,
    PED_OBJECTIVE_WAIT_IN_CAR = 27,
    PED_OBJECTIVE_UNKNOWN_28 = 28,
    PED_OBJECTIVE_UNKNOWN_29 = 29,
    PED_OBJECTIVE_UNKNOWN_30 = 30,
    PED_OBJECTIVE_UNKNOWN_31 = 31,
    PED_OBJECTIVE_UNKNOWN_32 = 32,
    PED_OBJECTIVE_UNKNOWN_33 = 33,
    PED_OBJECTIVE_UNKNOWN_34 = 34,
    PED_OBJECTIVE_ENTER_CAR_AS_DRIVER = 35,
    PED_OBJECTIVE_LEAVE_CAR = 36,
    PED_OBJECTIVE_UNKNOWN_37 = 37,
    PED_OBJECTIVE_UNKNOWN_38 = 38,
    PED_OBJECTIVE_UNKNOWN_39 = 39,
    PED_OBJECTIVE_UNKNOWN_40 = 40,
    PED_OBJECTIVE_UNKNOWN_41 = 41,
    PED_OBJECTIVE_UNKNOWN_42 = 42,
    PED_OBJECTIVE_UNKNOWN_43 = 43,
    PED_OBJECTIVE_UNKNOWN_44 = 44,
    PED_OBJECTIVE_UNKNOWN_45 = 45,
    PED_OBJECTIVE_UNKNOWN_46 = 46,
    PED_OBJECTIVE_UNKNOWN_47 = 47,
    PED_OBJECTIVE_UNKNOWN_48 = 48,
    PED_OBJECTIVE_UNKNOWN_49 = 49,
    PED_OBJECTIVE_UNKNOWN_50 = 50,
    PED_OBJECTIVE_UNKNOWN_51 = 51,
    PED_OBJECTIVE_UNKNOWN_52 = 52,
    PED_OBJECTIVE_UNKNOWN_53 = 53,
    PED_OBJECTIVE_UNKNOWN_54 = 54,
    PED_OBJECTIVE_FOLLOW_CAR_IN_CAR = 55,
    PED_OBJECTIVE_FOLLOW_CAR_ON_FOOT_WITH_OFFSET = 56,
    PED_OBJECTIVE_FIRE_AT_OBJECT_FROM_VEHICLE = 57,
    PED_OBJECTIVE_DESTROY_OBJECT = 58,
    PED_OBJECTIVE_DESTROY_CAR = 59
} PED_OBJECTIVE;
